...
/// <summary>
/// Benchmarks that simulate committing events using an implementation that keeps track of the Event Log Sequence Number in-memory, and uses InsertMany instead of InsertOne, and skips transactions for single-event commits.
/// This should functionally be the same as <see cref="WithInsertMany"/> but with a slight optimisation.
/// </summary>
public class SpecialCaseSingleEvent : JobBase 
{
